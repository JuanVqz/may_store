...
- `docs/references/wireframes.md` — Screens 9, 11, 12
- `docs/references/models.md` — Order status flow
...
- Closed orders are terminal — no reopen. See `docs/plans/decisions/26-04-17-closed-orders-terminal.md`.
...
### 9. Docs
- [x] Update `docs/references/wireframes.md` Screen 9: remove Tarjeta, remove Pago Dividido button (deferred)
- [ ] Update `docs/references/models.md` with Payment / PaymentMethod if missing

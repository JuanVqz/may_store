...
- [ ] Update `docs/references/models.md` — add `ready_by`, `cancelled_by`, `delivered_by` fields to LineItem
- [ ] Update `docs/references/turbo-streams.md` — add `store_{store_id}_kitchen` channel documentation

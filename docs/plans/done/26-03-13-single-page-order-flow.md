...
- `docs/references/wireframes.md` — Screens 3-6
- `docs/references/turbo-streams.md` — Broadcast architecture
...
See `docs/plans/decisions/26-03-13-keep-targeted-broadcasts.md` for rationale.
